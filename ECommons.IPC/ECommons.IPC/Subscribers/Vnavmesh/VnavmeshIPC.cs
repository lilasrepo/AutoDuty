...
public sealed class VnavmeshIPC : IPCBase
{
    ...
    // custom non-generic delegate types throw GetGenericTypeDefinition() on a non-generic Type.
    // Convert to equivalent Func<...> / Action<...> signatures.
    [EzIPC("Nav.Pathfind")] public Func<Vector3, Vector3, bool, Task<List<Vector3>>> Pathfind { get; private set; }
