...
public class CashFlowIPC : IPCBase
{
    ...
    /// Use asynchronously
    /// </summary>
    [EzIPC(nameof(GetGilRecords))] public Func<long, long, List<GilRecordSqlDescriptor>> GetGilRecords;

    /// <summary>
    /// Use asynchronously
    /// </summary>
    [EzIPC(nameof(GetPlayerInfo))] public Func<ulong, Sender?> GetPlayerInfo;
}
