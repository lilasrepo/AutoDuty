...
public sealed class RotationSolverRebornIPC : IPCBase
{
	...
	/// </remarks>
	[EzIPC] public Action<string> Test { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<uint> AddPriorityNameID { get; private set; }
    ...
    /// Delegate signature: <see cref="RotationSolverRebornIPC.Delegates.NameIdDelegate"/> (uint <c>nameId</c>).
    /// </remarks>
    [EzIPC] public Action<uint> RemovePriorityNameID { get; private set; }
    ...
    /// Delegate signature: <see cref="RotationSolverRebornIPC.Delegates.NameIdDelegate"/> (uint <c>nameId</c>).
    /// </remarks>
    [EzIPC] public Action<uint> AddBlacklistNameID { get; private set; }
    ...
    /// Delegate signature: <see cref="RotationSolverRebornIPC.Delegates.NameIdDelegate"/> (uint <c>nameId</c>).
    /// </remarks>
    [EzIPC] public Action<uint> RemoveBlacklistNameID { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<StateCommandType> ChangeOperatingMode { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<StateCommandType, TargetingType> AutodutyChangeOperatingMode { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<SpecialCommandType> TriggerSpecialState { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<OtherCommandType, string> OtherCommand { get; private set; }
    ...
    /// </remarks>
    [EzIPC] public Action<string, float> ActionCommand { get; private set; }
