...
public sealed class TextAdvanceIPC : IPCBase
{
    ...
    [EzIPC("EnqueueMoveTo2DPoint")] public Action<MoveData, float> EnqueueMoveTo2DPoint{get; private set;}
    [EzIPC("EnqueueMoveTo3DPoint")] public Action<MoveData, float> EnqueueMoveTo3DPoint{get; private set;}
    ...
    /// </summary>
    [EzIPC("EnableExternalControl")] public Func<string, ExternalTerritoryConfig, bool> EnableExternalControl{get; private set;}
    /// <summary>
    /// Disables external control. Will fail if external control is obtained from other plugin.
    /// </summary>
    [EzIPC("DisableExternalControl")] public Func<string, bool> DisableExternalControl{get; private set;}
    /// <summary>
