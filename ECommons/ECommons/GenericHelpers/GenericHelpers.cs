...
#pragma warning restore
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    // gap-fill 2026-08-30: upstream AutoDuty now passes JsonSerializerSettings. Signature and
    // body copied from the newer ECommons donor; the parameter is optional, so every existing
    // one-argument call site is unaffected.
